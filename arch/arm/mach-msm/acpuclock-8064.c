...
static struct l2_level l2_freq_tbl[] __initdata = {
	...
	[0]  = { {  378000, HFPLL, 2, 0x1C },  900000, 1000000, 1 },
	[1]  = { {  384000, PLL_8, 0, 0x00 },  900000, 1000000, 1 },
	[2]  = { {  432000, HFPLL, 2, 0x20 }, 1000000, 1000000, 2 },
	[3]  = { {  486000, HFPLL, 2, 0x24 }, 1000000, 1000000, 2 },
	[4]  = { {  540000, HFPLL, 2, 0x28 }, 1000000, 1000000, 2 },
	[5]  = { {  594000, HFPLL, 1, 0x16 }, 1000000, 1000000, 2 },
	[6]  = { {  648000, HFPLL, 1, 0x18 }, 1000000, 1000000, 4 },
	[7]  = { {  702000, HFPLL, 1, 0x1A }, 1000000, 1000000, 4 },
	[8]  = { {  756000, HFPLL, 1, 0x1C }, 1100000, 1100000, 4 },
	[9]  = { {  810000, HFPLL, 1, 0x1E }, 1100000, 1100000, 4 },
	[10] = { {  864000, HFPLL, 1, 0x20 }, 1100000, 1100000, 4 },
	[11] = { {  918000, HFPLL, 1, 0x22 }, 1100000, 1100000, 5 },
	[12] = { {  972000, HFPLL, 1, 0x24 }, 1100000, 1100000, 5 },
	[13] = { { 1026000, HFPLL, 1, 0x26 }, 1100000, 1100000, 5 },
	[14] = { { 1080000, HFPLL, 1, 0x28 }, 1100000, 1100000, 5 },
	[15] = { { 1134000, HFPLL, 1, 0x2A }, 1100000, 1100000, 5 },
	[16] = { { 1188000, HFPLL, 1, 0x2C }, 1100000, 1100000, 5 },
#else
